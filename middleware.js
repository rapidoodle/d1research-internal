...
export async function middleware(req) {
  ...
  const publicRoutePattern = /^\/(company-overview|consolidated-estimates|financial-overview\/annualized-discounts|financial-overview\/consolidated-estimates|financial-overview\/companies)\/[0-9a-fA-F-]{36}$/;
