...
export async function GET(req) {
  ...
  if(!equityTicker) {
    ...
    try {
      const data = await getFinancialDataByCompanyTicker(equityTicker, type === 'peer' ? 'dps_payout_ratio, year, company, equity_ticker, div_ticker, p_and_l_fx, div_future_fx' : '*');
