...
//   ];
  ...
  export const sensitivitiesMapping = {
    ...
    "Vbe - Net income (m)": "vbe_net_income_m_vbe",
    "Vbe - NI margin (%)": "vbe_ni_margin_percent_vbe",
    "Vbe - NI margin change (bp)": "vbe_ni_margin_change_bp_vbe",
    "Vbe - AWSC (m)": "vbe_awsc_m_vbe",
    "Vbe - EPS Vbe": "vbe_eps_vbe",
    "Vbe - EPS v Central %": "vbe_eps_v_central_percent_vbe",
    "DPS VBe1": "dps_vbe1",
    "DPS VBe2": "dps_vbe2",
    "DPS VBe3": "dps_vbe3",
    "DPS VBe4": "dps_vbe4",
    ...
    "Be - Net income (m)": "be_net_income_m_be",
    "Be - NI margin (%)": "be_ni_margin_percent_be",
    "Be - NI margin change (bp)": "be_ni_margin_change_bp_be",
    "Be - AWSC (m)": "be_awsc_m_be",
    "Be - EPS": "be_eps_be",
    "Be - EPS v Central %": "be_eps_v_central_percent_be",
    "DPS Be1": "dps_be1",
    "DPS Be2": "dps_be2",
    "DPS Be3": "dps_be3",
    "DPS Be4": "dps_be4",
    ...
    "Ce - Sales v Central %": "ce_sales_v_central_percent_ce",
    "Ce - Net income (m)": "ce_net_income_m_ce",
    "Ce - NI margin (%)": "ce_ni_margin_percent_ce",
    "Ce - NI margin change (bp)": "ce_ni_margin_change_bp_ce",
    "Ce - AWSC (m)": "ce_awsc_m_ce",
    "Ce - EPS": "ce_eps_ce",
    "Ce - EPS v Central %": "ce_eps_v_central_percent_ce",
    "DPS Ce1": "dps_ce1",
    "DPS Ce2": "dps_ce2",
    "DPS Ce3": "dps_ce3",
    "DPS Ce4": "dps_ce4",
    ...
    "Bu - Sales v Central %": "bu_sales_v_central_percent_bu",
    "Bu - Net income (m)": "bu_net_income_m_bu",
    "Bu - NI margin (%)": "bu_ni_margin_percent_bu",
    "Bu - NI margin change (bp)": "bu_ni_margin_change_bp_bu",
    "Bu - AWSC (m)": "bu_awsc_m_bu",
    "Bu - EPS": "bu_eps_bu",
    "Bu - EPS v Buntral %": "bu_eps_v_buntral_percent_bu",
    "DPS Bu1": "dps_bu1",
    "DPS Bu2": "dps_bu2",
    "DPS Bu3": "dps_bu3",
    "DPS Bu4": "dps_bu4",
    ...
    "VBu - Sales v Central %": "vbu_sales_v_central_percent_vbu",
    "VBu - Net income (m)": "vbu_net_income_m_vbu",
    "VBu - NI margin (%)": "vbu_ni_margin_percent_vbu",
    "VBu - NI margin change (bp)": "vbu_ni_margin_change_bp_vbu",
    "VBu - AWSC (m)": "vbu_awsc_m_vbu",
    "VBu - EPS": "vbu_eps_vbu",
    "VBu - EPS v Central %": "vbu_eps_v_central_percent_vbu",
    "DPS VBu1": "dps_vbu1",
    "DPS VBu2": "dps_vbu2",
    "DPS VBu3": "dps_vbu3",
    "DPS VBu4": "dps_vbu4",
...
export const sensitivitiesMapping2 = {
  "Year": "year",
  "Company": "company",
  "Equity Ticker": "equity_ticker",
  "V Bear": "v_bear",
...
export const sensitivitiesFirstHeader = {
  "Pay24VBe": "pay24vbe",
  "Pay24Be": "pay24be",
  "Pay24C": "pay24c",
  "Pay24Bu": "pay24bu",
...
export const sensitivitiesTableColumns = Object.keys(sensitivitiesMapping2).map(key => ({
  name: key,
