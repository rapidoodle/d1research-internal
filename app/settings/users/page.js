...
import NewUserForm from "@/app/ui/settings/users/newUserForm";
import UsersTable from "@/app/ui/settings/users/usersTable";
  ...
  return (
    <main>
      <div className="bg-light p-3 row">
        <h5 className="mb-0 col">Users</h5>
        ...
        <div className="ms-auto col d-flex justify-content-end">
          ...
          <Button size="sm" variant="primary" onClick={handleShow}>
            <FontAwesomeIcon icon={faPlus} className="me-1" /> Add new user
          </Button>
        </div>
      </div>
      ...
      <Modal size="lg" show={show} onHide={handleClose}>
          ...
          <Modal.Body>
          <NewUserForm onCompanyAdded={handleCompanyAdded} />
          </Modal.Body>
        </Modal>
    </main>
  )
